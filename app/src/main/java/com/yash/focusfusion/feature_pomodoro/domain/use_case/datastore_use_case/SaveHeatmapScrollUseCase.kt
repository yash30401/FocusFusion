...
class SaveHeatmapScrollUseCase @Inject constructor(
    private val datastoreRepository: DatastoreRepository,
) {

    suspend operator fun invoke(position: Int) = withContext(Dispatchers.IO) {
        datastoreRepository.saveHeatmapScroll(position)
    }
}