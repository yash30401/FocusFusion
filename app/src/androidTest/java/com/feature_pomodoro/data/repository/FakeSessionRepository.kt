package com.feature_pomodoro.data.repository
...
class FakeSessionRepository(private val dao: SessionDao) : SessionRepository {
    ...
    override fun getSessionsForWeek(
        ...
        return dao.getSessionsForWeek(startWeek, endWeek, month, year)
